  ...
  return (
    <div className='h-screen lg:h-[70vh] flex flex-col justify-center lg:flex-row items-center bg-PrimaryColor mt-14 lg:px-32 px-5'>
        ...
        <div className='w-full lg:w-2/4 space-y-4 pt-5 text-center lg:text-start'>
            ...
            <p>We have the best summer collection,
            Visit us for best collection in the Town.
            Each Item is a carefully chosen masterpiece, 
            promising not just fashion but reflection of 
            your unique style.
            </p>

            <button className='bg-ExtraDarkColor text-white px-4 py-2 font-medium active:bg-amber-800 rounded'>
                Shop Now
            </button>
        </div>
    </div>
